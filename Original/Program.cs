    ...
    public class Program
    {
        public static void Main(string[] args)
        {
            ...
            IList<Item> Items = new List<Item>{
                ...
                new Item {Name = HttpMethods.Sulfuras, SellIn = 0, Quality = HttpMethods.MaxSulfuras},
                new Item {Name = HttpMethods.Sulfuras, SellIn = -1, Quality = HttpMethods.MaxSulfuras},
